...
// Validate ../../app/admin/api-cost/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/admin/api-cost">> = Specific
  const handler = {} as typeof import("../../app/admin/api-cost/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/api/admin/tool-pricing/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/tool-pricing">> = Specific
  const handler = {} as typeof import("../../app/api/admin/tool-pricing/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
